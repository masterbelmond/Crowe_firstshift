/**
 * @NScriptName firstshift | UE | Customer Sync
 * @NScriptId customscript_ue_fs_customer_sync
 * @author eli@crowe
 * @filename firstshift_ue_customer_sync.js
 * @description User-event script to sync customer data to firstshift
 * @NApiVersion 2.x
   ...
   function (FS, runtime, record, https) {
      ...
      function afterSubmit(context){
         ...
         try {
            ...
            log.error({title: 'firstshift | UE | Customer Sync', details: JSON.stringify(ex)});
         }
      }
